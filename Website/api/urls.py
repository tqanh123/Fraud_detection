...
from .views import base,delete_data,upload_data,view_data,retrieve_data_by_id,change_password,login2,account_details,about,dashboard,userLogout,reports,upload_credit_data
