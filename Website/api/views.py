...
def prediction_button(request, id):
    ...
    try:
        ...
        # trained_model = load_model('Website/ModelTraining/LogisticRegressionModel')
    ...
    # Make predictions
        ...
        print("Model loaded successfully:", trained_rf_model)
...
def predict_fraud(request):
    if request.method == 'POST' and request.FILES.get('datafile'):
        ...
        predictions = trained_rf_model.transform(test_df)
        #proba...
def login2(request):
    data = {}
    if request.method == "POST":
